...
'' values to bee horse honey
Function BeeHorseHoney (ByRef Cookies As BOOLEAN)
'' heart script honey cute cute
Type ClickMessages Alias "Message Come Cookies"
         BeeScriptCome As Integer
         BeeScriptLiked  As Integer
         BeeScriptBody  As Integer
End Type
...
Function HeldScript (ByRef Titles As Integer) As Integer

'' supper cells
Dim HeldAdminButton As Short
Dim HeldSuperScripts As Short
Dim HeldCoolsBasics As Short

'' class verify delegate if your the sorry bee honey script god's
#If 0 
#Define Delagate names = Titles(HeldAdminButton, HeldSuperScript, HeldCoolsBasics)
#Define Delagate textitse = Titles(HeldAdminButton, HeldSuperScript, HeldCoolsBasics)
#Define Delagate backits = Titles(HeldAdminButton, HeldSuperScript, HeldCoolsBasics)
#Else
Print HeldAdminButton, HeldSuperScript, HeldCoolsBasics
#EndIf
